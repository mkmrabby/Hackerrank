...
The first line of the input contains Q where Q is the number of queries. The next Q lines contain  query each. Each query consists of two integers y and x where  is the type of the query and x is an integer.
...
For queries of type  print "Yes"(without quotes) if the number 3 is present in the set and if the number x is not present, then print "No"(without quotes).
